      ...
      <GlassCard className="p-5 lg:p-6">
        <div className="mb-5 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-[15px] leading-7 text-clinical-muted">Últimos atendimentos com contexto de canal e resolução.</p>
          </div>
        ...
        <div className="space-y-2">
          {recentConversations.map((conversation) => (
            ...
            >
              <span className="flex size-11 items-center justify-center rounded-2xl bg-clinical-blue/10 text-[13px] font-extrabold text-clinical-blueText">{conversation.initials}</span>
              <span className="min-w-0">
                <span className="block truncate text-[15px] font-extrabold text-clinical-dark">{conversation.patient}</span>
                <span className="mt-1 flex items-center gap-2 text-[14px] font-semibold text-clinical-muted">
              ...
              <span className="col-span-2 flex items-center justify-between gap-3 sm:col-span-1 sm:flex-col sm:items-end">
                ...
                <span className="text-[13px] font-bold text-clinical-muted/75">{conversation.time}</span>
              </span>
            </button>
          ))}
        </div>
