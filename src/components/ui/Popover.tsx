      ...
      {open && typeof document !== "undefined"
        ? createPortal(
            <div
              ...
              style={menuStyle}
              className={cn(
                "rounded-[24px] border border-white/60 bg-white/95 p-4 shadow-clinical backdrop-blur-xl",
                !matchTriggerWidth && width,
                className
              )}
            >
              <span
                className="absolute -top-1 size-2.5 -translate-x-1/2 rotate-45 border-l border-t border-white/60 bg-white/95"
