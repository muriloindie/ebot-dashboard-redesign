  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" && "bg-clinical-blue text-white shadow-glow hover:bg-clinical-blueHover",
        variant === "secondary" && "border border-clinical-blue/[0.15] bg-white/70 text-clinical-dark hover:border-clinical-blue/30 hover:bg-white",
