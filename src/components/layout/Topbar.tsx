...
export function Topbar({ onNavigate }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-clinical-border/[0.12] bg-clinical-surface/72 backdrop-blur-2xl">
        ...
        <div className="flex shrink-0 items-center justify-end gap-2">
          ...
          <div ref={notifMenuRef} className="relative">
            ...
            {notifMenuOpen ? (
              <div
                ref={notifPanelRef}
                className="absolute right-0 top-[calc(100%+12px)] z-50 w-[340px] origin-top-right rounded-[28px] border border-clinical-border/[0.14] bg-clinical-surface/[0.88] p-4 shadow-[0_24px_70px_rgba(38,53,50,0.16)] backdrop-blur-xl dark:border-white/[0.08]"
              >
                <span className="absolute -top-2 right-6 size-4 rotate-45 rounded-sm border-l border-t border-clinical-border/[0.14] bg-clinical-surface/[0.88] dark:border-white/[0.08]" />
          ...
          <div ref={userMenuRef} className="relative">
            ...
            {userMenuOpen ? (
              <div
                ref={userPanelRef}
                className="absolute right-0 top-[calc(100%+12px)] z-50 w-[320px] origin-top-right rounded-[28px] border border-clinical-border/[0.14] bg-clinical-surface/[0.88] p-4 shadow-[0_24px_70px_rgba(38,53,50,0.16)] backdrop-blur-xl dark:border-white/[0.08]"
              >
                <span className="absolute -top-2 right-8 size-4 rotate-45 rounded-sm border-l border-t border-clinical-border/[0.14] bg-clinical-surface/[0.88] dark:border-white/[0.08]" />
                <div className="relative z-10">
